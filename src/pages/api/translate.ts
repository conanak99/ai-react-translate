...
const SYSTEM_PROMPT_WUXIA = `You are a highly skilled translator and writer specializing in wuxia/xianxia novels.
...
const SYSTEM_PROMPT_FANTASY = `You are a highly skilled translator and writer specializing in fantasy novels.
...
async function getStreamResult(url: string): Promise<Result> {
  ...
  const result = await streamText({
    ...
    messages: [
      { role: "system", content: SYSTEM_PROMPT_WUXIA },
      {
        role: "user",
